...
uber_trip_jun_data <- read_csv(file = uber_raw_data_jun14_url, progress = TRUE)

uber_trip_jul_data <- read_csv(file = uber_raw_data_jul14_url, progress = TRUE)

uber_trip_aug_data <- read_csv(file = uber_raw_data_aug14_url, progress = TRUE)

uber_trip_sept_data <- read_csv(file = uber_raw_data_sept14_url, progress = TRUE)
```
